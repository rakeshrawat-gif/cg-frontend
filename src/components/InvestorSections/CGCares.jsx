    ...
    return (
        <div className="cg-cares-wrapper">
            ...
            <div className="tab-content">
                ...
                {/* Custom Slider */}
                <div className="cg-cares-slider-container">
                    <Swiper
                        modules={[Navigation]}
                        navigation={true}
                        centeredSlides={true}
                        slidesPerView={2.5}  // Center + partially visible sides
                        spaceBetween={30}
                        className="cg-cares-swiper"
                        breakpoints={{
                    ...
                    >
                        {[1, 2, 3, 4, 5].map((slide, index) => (
                            <SwiperSlide key={index}>
                                <div className="cg-cares-slide-content">
                                    <img src={`/images/cgcares/slide${slide}.jpg`} alt={`Slide ${slide}`} />
                                    <p>Slide {slide} caption here</p>
                                </div>
                            </SwiperSlide>
                        ))}
                    </Swiper>
